    ...
    try {
        ...
        if (photoSelectResult && photoSelectResult.photoUris && photoSelectResult.photoUris.length > 0) {
            ...
            if (imgUri.indexOf('media/image') < 0) {
                showToast({ "id": 16777372, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" });
                return null;
            }
        ...
        try {
            ...
            request.uploadFile(context, uploadRequestOptions).then((data) => {
                ...
                data.on("fail" /* FAIL */, (result) => {
                    ...
                    if (result && result.length >= 1) {
                        serverData.msg = { "id": 16777436, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" };
                        reject(serverData);
                    }
                });
            }).catch((err) => {
