...
export default class NewsList extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        ...
        this.__pullDownRefreshText = new ObservedPropertyObjectPU({ "id": 16777335, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" }, this, "pullDownRefreshText");
        this.__pullDownRefreshImage = new ObservedPropertyObjectPU({ "id": 16777431, "type": 20000, params: [], "bundleName": "com.example.component", "moduleName": "entry" }, this, "pullDownRefreshImage");
        ...
        this.__pullUpLoadText = new ObservedPropertyObjectPU({ "id": 16777336, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" }, this, "pullUpLoadText");
        this.__pullUpLoadImage = new ObservedPropertyObjectPU({ "id": 16777580, "type": 20000, params: [], "bundleName": "com.example.component", "moduleName": "entry" }, this, "pullUpLoadImage");
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("view/newslist.ets(76:5)");
    ...
    LoadingLayout(parent = null) {
        {
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                if (isInitialRender) {
                    ViewPU.create(new CustomRefreshLoadLayout(this, { customRefreshLoadClass: new CustomRefreshLoadLayoutClass(true, { "id": 16777580, "type": 20000, params: [], "bundleName": "com.example.component", "moduleName": "entry" }, { "id": 16777336, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" }, this.pullDownRefreshHeight) }, undefined, elmtId));
                }
                else {
                    this.updateStateVarsOfChildByElmtId(elmtId, {
                        customRefreshLoadClass: new CustomRefreshLoadLayoutClass(true, { "id": 16777580, "type": 20000, params: [], "bundleName": "com.example.component", "moduleName": "entry" }, { "id": 16777336, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" }, this.pullDownRefreshHeight)
                    });
                }
                ViewStackProcessor.StopGetAccessRecording();
            });
    ...
    ListLayout(parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            List.create();
            List.debugLine("view/newslist.ets(101:5)");
            ...
            List.backgroundColor({ "id": 16777237, "type": 10001, params: [], "bundleName": "com.example.component", "moduleName": "entry" });
            List.divider({
                color: { "id": 16777229, "type": 10001, params: [], "bundleName": "com.example.component", "moduleName": "entry" },
        ...
        });
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("view/newslist.ets(102:7)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    ...
                    const itemCreation = (elmtId, isInitialRender) => {
                        ...
                        ListItem.backgroundColor({ "id": 16777255, "type": 10001, params: [], "bundleName": "com.example.component", "moduleName": "entry" });
                        ListItem.margin({ top: NewsListConstant.ITEM_MARGIN_TOP });
                        ListItem.borderRadius(NewsListConstant.ITEM_BORDER_RADIUS);
                        ListItem.debugLine("view/newslist.ets(110:9)");
                        if (!isInitialRender) {
                            ListItem.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
        ...
        ForEach.pop();
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, isLazyCreate);
                ListItem.debugLine("view/newslist.ets(118:7)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
    ...
    FailLayout(parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777280, "type": 20000, params: [], "bundleName": "com.example.component", "moduleName": "entry" });
            Image.debugLine("view/newslist.ets(145:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/newslist.ets(148:5)");
