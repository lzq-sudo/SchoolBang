...
class SplashIndex extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/SplashPage.ets(64:5)");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/SplashPage.ets(65:7)");
            Image.width('200vp');
            Image.height({ "id": 16777607, "type": 10002, params: [], "bundleName": "com.example.component", "moduleName": "entry" });
            Image.margin({ top: '200vp', bottom: { "id": 16777608, "type": 10002, params: [], "bundleName": "com.example.component", "moduleName": "entry" } });
            if (!isInitialRender) {
                Image.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/SplashPage.ets(70:7)");
