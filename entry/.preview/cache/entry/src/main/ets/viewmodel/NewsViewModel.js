        ...
        return new Promise(async (resolve, reject) => {
            ...
            httpRequestGet(url).then((data) => {
                if (data.code === Constants.SERVER_CODE_SUCCESS) {
                    ...
                    reject({ "id": 16777328, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" });
                }
            }).catch((err) => {
                Logger.error('getNewsList failed', JSON.stringify(err));
                reject({ "id": 16777303, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" });
            });
        });
    }
    /**
        ...
        return new Promise((resolve, reject) => {
            ...
            httpRequestPost(url, newsData).then((result) => {
                if (result && result.code === Constants.SERVER_CODE_SUCCESS) {
                    ...
                    reject({ "id": 16777385, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" });
                }
            }).catch((err) => {
