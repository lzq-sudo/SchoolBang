...
export class CommonUtils {
    ...
    alertDialog(context) {
        AlertDialog.show({
            message: { "id": 16777222, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" },
            ...
            primaryButton: {
                value: { "id": 16777224, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" },
                action: () => {
                    Logger.info(CommonConstants.TAG_COMMON_UTILS, 'Callback cancel button is clicked');
                }
            },
            secondaryButton: {
                value: { "id": 16777230, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" },
                action: () => {
                    // Exiting the app.
