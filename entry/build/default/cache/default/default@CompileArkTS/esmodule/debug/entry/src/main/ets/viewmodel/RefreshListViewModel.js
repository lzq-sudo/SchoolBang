...
let RefreshListViewModel = class RefreshListViewModel {
    constructor() {
        ...
        this.offsetY = 0;
        this.hasMore = true;
        this.refreshLayoutClass = new RefreshLoadingClass({ "id": 16777546, "type": 20000, params: [], "bundleName": "com.example.component", "moduleName": "entry" }, { "id": 16777271, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" }, 0);
        this.loadingMoreClass = new RefreshLoadingClass({ "id": 16777547, "type": 20000, params: [], "bundleName": "com.example.component", "moduleName": "entry" }, { "id": 16777272, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" }, 0);
    ...
    pullRefreshState(state) {
        switch (state) {
            case 0 /* DropDown */:
                this.isCanRefresh = false;
                this.isRefreshing = false;
                this.refreshLayoutClass = new RefreshLoadingClass({ "id": 16777546, "type": 20000, params: [], "bundleName": "com.example.component", "moduleName": "entry" }, { "id": 16777271, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" }, Constants.CUSTOM_LAYOUT_HEIGHT);
                break;
            case 1 /* Release */:
                this.refreshLayoutClass.imageSrc = { "id": 16777548, "type": 20000, params: [], "bundleName": "com.example.component", "moduleName": "entry" };
                this.refreshLayoutClass.textValue = { "id": 16777282, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" };
                this.isCanRefresh = true;
                this.isRefreshing = false;
                break;
            case 2 /* Refreshing */:
                this.offsetY = vp2px(this.refreshLayoutClass.heightValue);
                this.refreshLayoutClass.imageSrc = { "id": 16777547, "type": 20000, params: [], "bundleName": "com.example.component", "moduleName": "entry" };
                this.refreshLayoutClass.textValue = { "id": 16777278, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" };
                this.isCanRefresh = true;
                this.isRefreshing = true;
                break;
            case 3 /* Success */:
                this.refreshLayoutClass.imageSrc = { "id": 16777552, "type": 20000, params: [], "bundleName": "com.example.component", "moduleName": "entry" };
                this.refreshLayoutClass.textValue = { "id": 16777277, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" };
                this.isCanRefresh = true;
                this.isRefreshing = true;
                break;
            case 4 /* Fail */:
                this.refreshLayoutClass.imageSrc = { "id": 16777531, "type": 20000, params: [], "bundleName": "com.example.component", "moduleName": "entry" };
                this.refreshLayoutClass.textValue = { "id": 16777276, "type": 10003, params: [], "bundleName": "com.example.component", "moduleName": "entry" };
                this.isCanRefresh = true;
                this.isRefreshing = true;
                break;
            default:
